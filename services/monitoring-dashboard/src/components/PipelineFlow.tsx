    ...
    <div style={{ background: '#1a1d2e', borderRadius: 12, padding: 24 }}>
      ...
      <div style={{ marginTop: 24, paddingTop: 20, borderTop: '1px solid #1e293b' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
          {([['Person', counts.person, '#3b82f6'], ['Account', counts.account, '#f59e0b'], ['Card', counts.card, '#8b5cf6'], ['MongoDB', counts.consolidation, '#10b981']] as const).map(([label, count, color]) => (
            <div key={label} style={{ background: '#0f1117', borderRadius: 8, padding: '10px 12px', textAlign: 'center', border: `1px solid ${color}33` }}>
